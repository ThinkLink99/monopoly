...
namespace linkopoly_api
{
    ...
    public class Game
    {
        ...
        void get_properties()
        {
            ...
            {
                new Property("prop1", Colors.Brown, 0,0,0,0,0,0,40,0),
                new Property("Baltic Avenue", Colors.Brown, 0,0,0,0,0,0,60,0),
                new Property("Reading Railroad", Colors.Railroad, 0,0,0,0,0,0,100,0),
                new Property("Oriental Avenue", Colors.LightBlue, 0,0,0,0,0,0,150,0),
                new Property("Vermont Avenue", Colors.LightBlue, 0,0,0,0,0,0,180,0),
                new Property("Conneticut Avenue", Colors.LightBlue, 0,0,0,0,0,0,0,0),
                new Property("St. Charles Place", Colors.Magenta, 0,0,0,0,0,0,0,0),
                new Property("Electric Company", Colors.Utility, 0,0,0,0,0,0,0,0),
                new Property("States Avenue", Colors.Magenta, 0,0,0,0,0,0,0,0),
                new Property("Virginia Avenue", Colors.Magenta, 0,0,0,0,0,0,0,0),
                new Property("Pennsilvania Railroad", Colors.Railroad, 0,0,0,0,0,0,0,0),
                new Property("St. James Place", Colors.Orange, 0,0,0,0,0,0,0,0),
                new Property("Tennesse Avenue", Colors.Orange, 0,0,0,0,0,0,0,0),
                new Property("New York Avenue", Colors.Orange, 0,0,0,0,0,0,0,0),
                new Property("Kentucky Avenue", Colors.Red, 0,0,0,0,0,0,0,0),
                new Property("Indiana Avenue", Colors.Red, 0,0,0,0,0,0,0,0),
                new Property("Illinois Avenue", Colors.Red, 0,0,0,0,0,0,0,0),
                new Property("B & O Railroad", Colors.Railroad, 0,0,0,0,0,0,0,0),
                new Property("Atlantic Avenue", Colors.Yellow, 0,0,0,0,0,0,0,0),
                new Property("prop16", Colors.Yellow, 0,0,0,0,0,0,0,0),
                new Property("Water Works", Colors.Utility, 0,0,0,0,0,0,0,0),
                new Property("Marvin Gardens", Colors.Yellow, 0,0,0,0,0,0,0,0),
                new Property("Pacific Avenue", Colors.Green, 0,0,0,0,0,0,0,0),
                new Property("North Carolina Avenue", Colors.Green, 0,0,0,0,0,0,0,0),
                new Property("Philidelphia Avenue", Colors.Green, 0,0,0,0,0,0,0,0),
                new Property("Short Line", Colors.Railroad, 0,0,0,0,0,0,0,0),
                new Property("Park Place", Colors.DarkBlue, 0,0,0,0,0,0,0,0),
                new Property("Boardwalk", Colors.DarkBlue, 0,0,0,0,0,0,0,0),
        };
        }
        void replenish_bank ()
        {
